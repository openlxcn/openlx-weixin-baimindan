...
**[产品与安装](https://wx.openlx.cn/skills/openlx-weixin-baimindan) · [首次授权](https://wx.openlx.cn/account?authorize=1) · [体验与权益](https://wx.openlx.cn/account?intent=trial) · [English](README.en.md)**
...
## 兼容与验证
[兼容矩阵](compatibility-matrix.json) 和 [命令矩阵](install-command-matrix.json) 记录真实验证层级。目录安装不代表完整宿主验证；仅 VERIFIED 标绿色。
